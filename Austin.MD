...
| Count proximate bikesharing stations | [PostGIS](Aus_bstations.txt) | Austin's grid (4), [Bikesharing stations](https://data.austintexas.gov/Transportation-and-Mobility/Austin-MetroBike-Kiosk-Locations/qd73-bsdg) | Austin's grid (5) | [Bus stops and routes](https://data.texas.gov/Transportation/Capital-Metro-Shapefiles-JANUARY-2020/63b7-hxaj) | Austin's grid (6) |
| Count bus stops | [PostGIS](Aus_bus.txt) | Austin's grid (5), 
