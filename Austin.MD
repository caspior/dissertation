...
For the GWR analysis I used ArcGIS Desktop's GUI. The spatial distribution of the variables used in this analysis can be found [here]. The GWR outputs can be found [here].
