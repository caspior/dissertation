...
I used this [R Markdown](Aus_Spreg.Rmd)
...
For the GWR analysis I used ArcGIS Desktop's GUI. The spatial distribution of the variables used in this analysis can be found [here]. The GWR outputs can be found [here] for all the trips and [here] for the morning trips.
