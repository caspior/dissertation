...
### Summary Table
| Description | Code | Input | Output |
| --- | --- | --- | --- |
| Cleaning dockless trip log | [R](Aus_Cleaning.R) | [Austin's Dockless trip log](https://drive.google.com/file/d/1uHDza25XWuaCml3jeToR6JMtOgbNwScx/view?usp=sharing) | |
