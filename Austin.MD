...
| Calculate land use proportions | [PostGIS](Aus_lu.txt) | Austin's grid (2), [Austin's land uses](https://data.austintexas.gov/Locations-and-Maps/Land-Use-Inventory-Detailed/fj9m-h5qy) | Austin's (3) |
| Calculate bikeway variables | | [Bikeways shapefile (retrieved from OSM)](Aus_bikeways.zip), [Road centerlines](https://data.austintexas.gov/Locations-and-Maps/Street-Centerline/m5w3-uea6), Austin's grid (3) | Austin's grid (4) |
