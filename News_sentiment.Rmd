...
articles[which(articles$att<0),13] <- floor(articles[which(articles$att<0),13])
articles[which(articles$att>0),13] <- ceiling(articles[which(articles$att>0),13])
